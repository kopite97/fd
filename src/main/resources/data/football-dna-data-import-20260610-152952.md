...
- Imported At: 2026-06-10T15:29:52.423504
...
```text
is_active=TRUE, city=London, country=England, club_name=Arsenal, club_id=ARS, season=2026-27, note=2026-27 EPL 기준 초기 데이터, league=EPL
is_active=TRUE, city=Birmingham, country=England, club_name=Aston Villa, club_id=AVL, season=2026-27, note=2026-27 EPL 기준 초기 데이터, league=EPL
is_active=TRUE, city=Bournemouth, country=England, club_name=Bournemouth, club_id=BOU, season=2026-27, note=2026-27 EPL 기준 초기 데이터, league=EPL
```
...
```text
club_name=Arsenal, growth=4, fan_culture=4, season=2026-27, club_prestige=5, popularity=5, club_id=ARS, source_type=MANUAL_ANCHOR, star_power=4, local_identity=3, drama=4, underdog=2, note=초기 주관 채점. 추후 커뮤니티 의견 반영 가능
club_name=Aston Villa, growth=4, fan_culture=4, season=2026-27, club_prestige=3, popularity=3, club_id=AVL, source_type=MANUAL_ANCHOR, star_power=3, local_identity=4, drama=3, underdog=3, note=초기 주관 채점. 추후 커뮤니티 의견 반영 가능
club_name=Bournemouth, growth=3, fan_culture=2, season=2026-27, club_prestige=1, popularity=1, club_id=BOU, source_type=MANUAL_ANCHOR, star_power=1, local_identity=3, drama=2, underdog=5, note=초기 주관 채점. 추후 커뮤니티 의견 반영 가능
```
...
```text
note=목업 데이터, directness=3, source_type=MANUAL_MOCK, raw_source=Eye Test, pressing=4, transition_speed=3, organization=5, club_name=Arsenal, season=2026-27, possession=5, creativity=3, club_id=ARS
note=목업 데이터, directness=4, source_type=MANUAL_MOCK, raw_source=Eye Test, pressing=3, transition_speed=4, organization=3, club_name=Aston Villa, season=2026-27, possession=3, creativity=4, club_id=AVL
note=목업 데이터, directness=4, source_type=MANUAL_MOCK, raw_source=Eye Test, pressing=3, transition_speed=4, organization=2, club_name=Bournemouth, season=2026-27, possession=2, creativity=2, club_id=BOU
```
...
```text
trend=안정기, note=초기 설명용 상태값, club_id=ARS, competition_tier=우승후보, club_name=Arsenal, source_type=MANUAL, season=2026-27
trend=상승세, note=초기 설명용 상태값, club_id=AVL, competition_tier=도전자, club_name=Aston Villa, source_type=MANUAL, season=2026-27
trend=리빌딩, note=초기 설명용 상태값, club_id=BOU, competition_tier=생존경쟁, club_name=Bournemouth, source_type=MANUAL, season=2026-27
```
...
```text
club_id=ARS, is_active=TRUE, note=초기 UI 태그 후보, club_name=Arsenal, display_order=1, tag=#명문클럽
club_id=ARS, is_active=TRUE, note=초기 UI 태그 후보, club_name=Arsenal, display_order=2, tag=#북런던
club_id=ARS, is_active=TRUE, note=초기 UI 태그 후보, club_name=Arsenal, display_order=3, tag=#아르테타프로젝트
```
...
```text
score=5, metric_name=클럽 위상, category=감성, anchor_club=Liverpool / Manchester United, metric_key=club_prestige, description=세계 축구 역사에서 중요한 위치를 가진 클럽
score=3, metric_name=클럽 위상, category=감성, anchor_club=Tottenham / Newcastle, metric_key=club_prestige, description=EPL에서 확실한 존재감이 있는 클럽
score=1, metric_name=클럽 위상, category=감성, anchor_club=Bournemouth / Hull City, metric_key=club_prestige, description=EPL 내 역사적 영향력이 제한적인 클럽
```
