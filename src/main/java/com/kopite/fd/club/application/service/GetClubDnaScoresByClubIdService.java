...
public class GetClubDnaScoresByClubIdService {

    private final ClubDnaScoreRepository clubDnaScoreRepository;

    public List<ClubDnaScoreResult> getClubDnaScoresByClubId(GetClubDnaScoresByClubIdQuery query) {
        ...
        return clubDnaScoreRepository.findByClubIdAndDataVersion(query.clubId(), dataVersion).stream()
                .map(this::toResult)
                .toList();
    }
